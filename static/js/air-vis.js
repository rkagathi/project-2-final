var vis = function(data) {
  ...
  var map = (function() {
    ...
    d3.json("static/data/chicago.json", function(json) {
...
// load data
d3.csv('static/data/values.csv', function(values) {
  d3.csv('static/data/locations.csv', function(locations) {
    d3.csv('static/data/map.csv', function(map) {
      d3.csv('static/data/location-coord.csv', function(coord) {
